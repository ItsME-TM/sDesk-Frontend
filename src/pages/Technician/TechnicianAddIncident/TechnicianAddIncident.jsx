...
const TechnicianAddIncident = () => {
    ...
    const handleRemoveFile = () => {
        ...
        const incidentData = {
            ...
            urgent_notification_to: userData[0].email || 'technician@company.com',
            Attachment: selectedFile ? selectedFile.name : null,
        };

        console.log('[TechnicianAddIncident] Creating incident with data:', incidentData);
    ...
    return (        <div className="TechnicianAddInicident-main-content">
            <div className="TechnicianAddInicident-tickets-creator">
                       <span className="TechnicianAddInicident-svr-desk">Incidents</span>
                       <IoIosArrowForward />
                       <span className="TechnicianAddInicident-created-ticket">Add Incident</span>
                     </div>
            
            {renderStatusMessage()}
            
            <div className="TechnicianAddInicident-content2">                <AffectedUserDetails
                    formData={formData}
