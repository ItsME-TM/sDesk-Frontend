...
const AdminCategory = () => {
    ...
    const confirmDelete = () => {
        if (deleteTargetID) {
            ...
            const item = categoryItems.find(item => item.category_code === deleteTargetID);
            if (item && item.id) {
    ...
    const filteredCategories = categories.filter(category => {
        const matchesSearch =
            ...
            category.subCategoryName.toLowerCase().includes(searchQuery.toLowerCase()) ||
            category.parentCategoryName.toLowerCase().includes(searchQuery.toLowerCase());
        const matchesFilter =
            selectShowOption === 'All' || category.parentCategoryName === selectShowOption;
