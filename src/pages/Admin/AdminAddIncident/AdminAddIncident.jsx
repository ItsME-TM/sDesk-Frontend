...
const AdminAddIncident = () => {
    ...
    // For demo purposes, create a mock admin user data
    const userData = [{
    ...
    const handleRemoveFile = () => {
        ...
        }).map(field => field.label);        if (missingFields.length > 0) {
        ...
        const incidentData = {
            ...
            informant: user?.serviceNum || userData[0].service_number, // Use admin's service number as informant (properly trimmed)
            ...
            urgent_notification_to: userData[0].email || 'admin@company.com',
            Attachment: selectedFile ? selectedFile.name : null,
        };        console.log('[AdminAddIncident] Creating incident with data:', incidentData);
        console.log('[AdminAddIncident] Admin serviceNum:', user?.serviceNum);
        console.log('[AdminAddIncident] Affected user serviceNum:', formData.serviceNo);
    ...
    return (        <div className="AdminAddInicident-main-content">
            ...
            <div className="AdminAddInicident-content2">                <AffectedUserDetails
                    formData={formData}
